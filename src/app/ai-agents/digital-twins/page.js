...
import { ArrowLeft, MessageCircle, Lock, Eye, Factory, Cpu } from 'lucide-react';
      ...
      <div className="pb-16">
        <div className="max-w-5xl mx-auto px-6">
              ...
              {[
                {
                  ...
                  description: "Real-time sensor telemetry from manufacturing assets — temperature, vibration, force, power — streamed into a live digital twin graph"
                },
                {
                  icon: <Cpu className="w-6 h-6 text-blue-300" />,
                  title: "AI-Powered Anomaly Detection",
                  description: "Predictive maintenance and anomaly detection layer that identifies equipment issues before they cause downtime"
                }
              ].map((item, i) => (
          ...
          <div className="text-center">
            <Link
              href="/contact"
              className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700 text-white font-semibold rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg"
            >
