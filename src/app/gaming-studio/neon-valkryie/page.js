...
export default function NeonValkyrie() {
  return (
    <div className="py-20">
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <div>
              <p className="text-lg text-purple-100 leading-relaxed">
                Enter a cyberpunk world as a neon-powered valkyrie warrior! Slice through enemies with style in this action-packed game featuring stunning neon visuals and smooth combat.
              </p>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <a 
                href="https://play.google.com/store/apps/details?id=com.AlphaCodeLabs.NeonValkyrie"
                target="_blank" 
            ...
            <div className="text-center">
              <Link 
                href="/gaming-studio/neon-valkryie/privacy-policy" 
