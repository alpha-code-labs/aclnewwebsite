...
export default function NeonValkyriePrivacy() {
  return (
    <div className="py-20">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mb-8">
          <Link 
            href="/gaming-studio/neon-valkryie"
          ...
          >
            ...
            <span className="font-medium">Back to Neon Valkyrie</span>
          </Link>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-purple-400/20">
          ...
          <div className="prose prose-invert max-w-none text-purple-100 leading-relaxed space-y-6">
            ...
            <p>
              This Privacy Policy governs the use of the mobile game <strong className="text-white">Neon Valkyrie</strong> (hereby referred to as &quot;Application&quot;) developed by <strong className="text-white">Alpha Code Labs</strong> (hereby referred to as &quot;Service Provider&quot;). This Application is provided as a free game and is intended for use &quot;AS IS.&quot;
            </p>
            ...
            <div className="space-y-6">
              ...
              <section>
                ...
                <p>
                  Neon Valyrie does not collect, store, or share any personal data from its users. The game does not require users to create accounts, provide personal information (such as name, email address, or phone number), or grant access to device features beyond what is required for normal gameplay.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                    Neon Valkyrie is built using the Unity game engine. While the game itself does not collect any data, please be aware that Unity may collect certain technical data (e.g., device model, operating system, unique device identifiers) solely for performance analytics or crash reporting. This data collection, if any, is governed by Unity&apos;s own privacy policy. We recommend reviewing Unity&apos;s Privacy Policy to understand their data-handling practices.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  Although Neon Valkyrie does not collect personal information, we are committed to ensuring that our game and any minimal technical data collected through Unity adhere to industry-standard security measures. Users are advised to keep their mobile devices updated and secure against unauthorized access.
                </p>
              </section>
