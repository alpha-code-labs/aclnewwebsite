          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <div>
              <p className="text-lg text-purple-100 leading-relaxed">
                Race through the cosmos in this high-speed space adventure! Dodge asteroids, collect power-ups, and explore the infinite universe in this thrilling endless runner.
              </p>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <a 
                href="https://play.google.com/store/apps/details?id=com.AlphaCodeLabs.SpaceRunner"
                target="_blank" 
            ...
            <div className="text-center">
              <Link 
                href="/gaming-studio/space-runner/privacy-policy" 
