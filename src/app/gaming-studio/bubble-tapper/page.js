...
export default function BubbleTapper() {
  return (
    <div className="py-20">
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <div>
              <p className="text-lg text-purple-100 leading-relaxed">
                Pop your way to relaxation with this satisfying bubble-tapping game! Beautiful bubbles, soothing sounds, and endless popping fun make this the perfect stress reliever.
              </p>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <a 
                href="https://play.google.com/store/apps/details?id=com.AlphaCodeLabs.BubbleTapper"
                target="_blank" 
            ...
            <div className="text-center">
              <Link 
                href="/gaming-studio/bubble-tapper/privacy-policy" 
