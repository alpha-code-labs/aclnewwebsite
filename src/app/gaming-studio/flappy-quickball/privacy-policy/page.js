...
export default function FlappyQuickballPrivacy() {
  return (
    <div className="py-20">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mb-8">
          <Link 
            href="/gaming-studio/flappy-quickball"
          ...
          >
            ...
            <span className="font-medium">Back to Flappy Quickball</span>
          </Link>
        </div>
          ...
          <div className="prose prose-invert max-w-none text-purple-100 leading-relaxed space-y-6">
            ...
            <div className="space-y-6">
              ...
              <section>
                ...
                <p>
                  Flappy Quickball does not collect, store, or share any personal data from its users. The game does not require users to create accounts, provide personal information (such as name, email address, or phone number), or grant access to device features beyond what is required for normal gameplay.
                </p>
              </section>
