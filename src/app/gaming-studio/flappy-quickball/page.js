...
export default function FlappyQuickball() {
  return (
    <div className="py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            <div className="relative overflow-hidden rounded-3xl shadow-2xl h-[500px]">
              <Image 
                src="/games/flappy-quickball.png"
                alt="Flappy Quickball"
                fill
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <div>
              <p className="text-lg text-purple-100 leading-relaxed">
                Fly as a cricket ball into the distance. Cover maximum distance and beat your friends.
              </p>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <a 
                href="https://play.google.com/store/apps/details?id=com.AlphaCodeLabs.FlappyQuickball"
                target="_blank" 
            ...
            <div className="text-center">
              <Link 
                href="/gaming-studio/flappy-quickball/privacy-policy" 
