...
export default function DivineQuest() {
  return (
    <div className="py-20">
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <div>
              <p className="text-lg text-purple-100 leading-relaxed">
                Embark on a mystical journey through divine realms! Solve ancient puzzles, discover sacred treasures, and uncover the mysteries of the gods in this epic adventure.
              </p>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <a 
                href="https://play.google.com/store/apps/details?id=com.AlphaCodeLabs.DivineQuest2D"
                target="_blank" 
            ...
            <div className="text-center">
              <Link 
                href="/gaming-studio/divine-quest/privacy-policy" 
