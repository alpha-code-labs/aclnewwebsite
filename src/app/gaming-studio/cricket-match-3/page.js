...
export default function CricketMatch3() {
  return (
    <div className="py-20">
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <div>
              <p className="text-lg text-purple-100 leading-relaxed">
                Our cricket twist to the classic Match 3 genre. 
              </p>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <a 
                href="https://play.google.com/store/apps/details?id=com.alphacodelabs.cricketmatch3"
                target="_blank" 
            ...
            <div className="text-center">
              <Link 
                href="/gaming-studio/cricket-match-3/privacy-policy" 
