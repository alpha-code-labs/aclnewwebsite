...
export default function BoostProtocol() {
  return (
    <div className="py-20">
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <div>
              <p className="text-lg text-purple-100 leading-relaxed">
                Activate the boost protocol and race through futuristic tracks! High-speed action meets strategic boosting in this adrenaline-pumping space experience.
              </p>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <a 
                href="https://play.google.com/store/apps/details?id=com.AlphaCodeLabs.BoostProtocolTerminalVelocity"
                target="_blank" 
            ...
            <div className="text-center">
              <Link 
                href="/gaming-studio/boost-protocol/privacy-policy" 
