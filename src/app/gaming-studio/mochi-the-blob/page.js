...
export default function MochitheBlob() {
  return (
    <div className="py-20">
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <div>
              <p className="text-lg text-purple-100 leading-relaxed">
                Meet Mochi, the adorable blob on an epic adventure! Jump, bounce, and squish through colorful worlds in this delightfully cute platformer that&apos;s easy to play but hard to master.
              </p>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <a 
                href="https://play.google.com/store/apps/details?id=com.AlphaCodeLabs.MochiTheBlob"
                target="_blank" 
