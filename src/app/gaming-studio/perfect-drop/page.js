...
export default function PerfectDrop() {
  return (
    <div className="py-20">
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <div>
              <p className="text-lg text-purple-100 leading-relaxed">
                Master the art of perfect timing! Drop objects with precision in this minimalist puzzle game that&apos;s easy to learn but challenging to master. Can you achieve the perfect drop?
              </p>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <a 
                href="https://play.google.com/store/apps/details?id=com.AlphaCodeLabs.PerfectDrop"
                target="_blank" 
            ...
            <div className="text-center">
              <Link 
                href="/gaming-studio/perfect-drop/privacy-policy" 
