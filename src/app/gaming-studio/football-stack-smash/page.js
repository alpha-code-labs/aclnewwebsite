...
export default function FootballStackSmash() {
  return (
    <div className="py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            <div className="relative overflow-hidden rounded-3xl shadow-2xl h-[500px]">
              <Image 
                src="/games/football-stack-smash.jpg"
                alt="Football Stack Smash"
                fill
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 bg-gradient-to-r from-purple-200 to-pink-200 bg-clip-text text-transparent">
              Football Stack Smash
            </h1>

            {/* 1. Game Description */}
            <div>
              <p className="text-lg text-purple-100 leading-relaxed">
                Score goals and smash stacks in this football-themed arcade game! Perfect your kicks, break through defenses, and become the ultimate football stack smasher.
              </p>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <a 
                href="https://play.google.com/store/apps/details?id=com.AlphaCodeLabs.Football_Stack_Smash"
                target="_blank" 
            ...
            <div className="text-center">
              <Link 
                href="/gaming-studio/football-stack-smash/privacy-policy" 
