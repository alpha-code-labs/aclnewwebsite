...
export default function FootballStackSmashPrivacy() {
  return (
    <div className="py-20">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mb-8">
          <Link 
            href="/gaming-studio/football-stack-smash"
          ...
          >
            ...
            <span className="font-medium">Back to Football Stack Smash</span>
          </Link>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-purple-400/20">
          ...
          <div className="prose prose-invert max-w-none text-purple-100 leading-relaxed space-y-6">
            ...
            <p>
              This Privacy Policy governs the use of the mobile game <strong className="text-white">Football Stack Smash</strong> (hereby referred to as &quot;Application&quot;) developed by <strong className="text-white">Alpha Code Labs</strong> (hereby referred to as &quot;Service Provider&quot;). This Application is provided as a free game and is intended for use &quot;AS IS.&quot;
            </p>
