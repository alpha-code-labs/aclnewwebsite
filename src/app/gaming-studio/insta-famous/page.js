...
export default function InstaFamous() {
  return (
    <div className="py-20">
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <div>
              <p className="text-lg text-purple-100 leading-relaxed">
                Experience the beats of becoming an Instagram influencer. Answer questions, and tread your way carefully to becoming a top influencer.
              </p>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <a 
                href="https://play.google.com/store/apps/details?id=com.AlphaCodeLabs.maide_Cafe_Run"
                target="_blank" 
            ...
            <div className="text-center">
              <Link 
                href="/gaming-studio/insta-famous/privacy-policy" 
