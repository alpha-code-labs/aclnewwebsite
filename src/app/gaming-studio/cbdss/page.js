...
export default function CricketStackSmash() {
  return (
    <div className="py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            <div className="relative overflow-hidden rounded-3xl shadow-2xl h-[500px]">
              <Image 
                src="/games/cricket-stack-smash.jpg"
                alt="Cricket Stack Smash"
                fill
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <div>
              <p className="text-lg text-purple-100 leading-relaxed">
                Experience the thrill of cricket like never before! Stack, smash, and score your way to victory in this addictive hypercasual cricket game. Perfect your timing and become the ultimate cricket champion.
              </p>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <a 
                href="https://play.google.com/store/apps/details?id=com.AlphaCodeLabs.drop_stack_ball_game"
                target="_blank" 
            ...
            <div className="text-center">
              <Link 
                href="/gaming-studio/cbdss/privacy-policy" 
