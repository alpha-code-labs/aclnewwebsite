...
export default function ChessCricket() {
  return (
    <div className="py-20">
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <div>
              <p className="text-lg text-purple-100 leading-relaxed">
                Play chess with a cricket twist. Outscore your opponent in chess by scoring cricket runs. 
              </p>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <a 
                href="https://play.google.com/store/apps/details?id=com.alphacodelabs.chesscricket"
                target="_blank" 
            ...
            <div className="text-center">
              <Link 
                href="/gaming-studio/chess-cricket/privacy-policy" 
