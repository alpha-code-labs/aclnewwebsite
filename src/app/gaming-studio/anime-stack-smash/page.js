        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            <div className="relative overflow-hidden rounded-3xl shadow-2xl h-[500px]">
              <Image 
                src="/games/anime-stack-smash.jpg"
                alt="Anime Stack Smash"
                fill
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <div>
              <p className="text-lg text-purple-100 leading-relaxed">
                Smash through anime-inspired stacks with style! Featuring beautiful art and satisfying destruction mechanics, this game combines classic stack-breaking with stunning anime aesthetics.
              </p>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <a 
                href="https://play.google.com/store/apps/details?id=com.AlphaCodeLabs.Anime_Stack_Smash"
                target="_blank" 
