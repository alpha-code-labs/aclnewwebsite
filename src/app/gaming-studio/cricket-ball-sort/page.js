...
export default function CricketSort() {
  return (
    <div className="py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            <div className="relative overflow-hidden rounded-3xl shadow-2xl h-[500px]">
              <Image 
                src="/games/cricket-ball-sort.jpg"
                alt="Cricket Ball Sort"
                fill
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <div>
              <p className="text-lg text-purple-100 leading-relaxed">
                Sort cricket balls by color in this satisfying puzzle game! A simple yet challenging brain teaser that will keep you hooked for hours. Can you master the perfect sort?
              </p>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <a 
                href="https://play.google.com/store/apps/details?id=com.alphacodelabs.cricketballsort"
                target="_blank" 
            ...
            <div className="text-center">
              <Link 
                href="/gaming-studio/cricket-ball-sort/privacy-policy" 
