...
export default function JourneyOfACricketer() {
  return (
    <div className="py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            <div className="relative overflow-hidden rounded-3xl shadow-2xl h-[500px]">
              <Image 
                src="/games/journey-of-a-cricketer.jpg"
                alt="Journey Of A Cricketer"
                fill
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <div>
              <p className="text-lg text-purple-100 leading-relaxed">
                Follow the inspiring journey from street cricket to international stardom! Make crucial decisions, train hard, and live the dream of every cricket enthusiast in this immersive story-driven game.
              </p>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <a 
                href="https://play.google.com/store/apps/details?id=com.AlphaCodeLabs.games.android.JOAC"
                target="_blank" 
            ...
            <div className="text-center">
              <Link 
                href="/gaming-studio/journey-of-a-cricketer/privacy-policy" 
