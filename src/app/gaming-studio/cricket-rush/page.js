...
export default function CricketRush() {
  return (
    <div className="py-20">
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <div>
              <p className="text-lg text-purple-100 leading-relaxed">
                Experience the rush of playing the endless runner game viewed through the lens of a cricket player. 
              </p>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <a 
                href="https://play.google.com/store/apps/details?id=com.AlphaCodeLabs.CricketRunner"
                target="_blank" 
            ...
            <div className="text-center">
              <Link 
                href="/gaming-studio/cricket-rush/privacy-policy" 
